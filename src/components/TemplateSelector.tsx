    ...
    <div className="h-screen bg-[#141c0d] flex flex-col text-white overflow-hidden">
      ...
      {showPublicClone && (
        <div className="fixed inset-0 z-50 bg-black/80 flex items-end" onClick={() => { if (!cloneLoading) { setShowPublicClone(false); setCloneUrl(""); setCloneStatus(null); } }}>
          <div className="w-full bg-[#1c2714] border-t border-green-500/30 rounded-t-3xl overflow-hidden shadow-2xl" onClick={e => e.stopPropagation()}>
            ...
            <div className="p-5 pb-safe-bottom space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-3 py-3 bg-[#141c0d] border border-gray-700/50 rounded-xl text-sm text-gray-300 placeholder-gray-700 outline-none focus:border-green-500/50"
